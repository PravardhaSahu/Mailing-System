...
public class Table1 extends javax.swing.JFrame {
    ...
    public Table1() {
        ...
        try
        {
            String sender,sub,date,time;
            DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
            Class.forName("oracle.jdbc.OracleDriver");
            Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","mca");
            Statement stm= conn.createStatement();
            System.out.println("Database");
            String sql="select sender,subject,sending_date,sending_time from user_inbox where reciever=\'mansi\'";
              ...
              while(rs.next())
               {
                   ...
                   model.addRow(new Object[]{sender,sub,date,time});
               }
           }
           conn.close();
           stm.close();
